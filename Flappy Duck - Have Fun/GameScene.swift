...
//        scoreLabel.fontColor = SKColor(red: 167.0/255.0, green: 169.0/255.0, blue: 171.0/255.0, alpha: 1.0)
    ...
    func createObstacle() -> SKSpriteNode {
        ...
        sprite.physicsBody = SKPhysicsBody(polygonFromPath: Utils.getObstaclePath(offsetX, offsetY: offsetY))
    ...
    func switchToFalling() {
        ...
        whiteNode.runAction(SKAction.removeFromParentAfterDelay(0.1))
